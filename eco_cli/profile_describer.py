...
Used by ``eco profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``eco_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the ECO Agent kanban board.
...
Rules:
  ...
  - Never write "ECO Agent profile" or other meta-narration.
