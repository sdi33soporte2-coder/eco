...
(excluding the eco repo and transient files).
...
_EXCLUDED_DIRS = {
    "eco",     # the codebase repo — re-clone instead
...
def run_import(args) -> None:
    ...
    with zipfile.ZipFile(zip_path, "r") as zf:
        ...
        # Guidance
        print()
        if not (eco_root / "eco").is_dir():
            print("Note: The eco codebase was not included in the backup.")
