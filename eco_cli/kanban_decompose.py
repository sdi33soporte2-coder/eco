...
Invoked by ``eco kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the ECO Agent board.
...
def _profile_author() -> str:
    """Mirror of ``eco_cli.kanban._profile_author``."""
    return (
