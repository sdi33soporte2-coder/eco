"""
Skills configuration for ECO Agent.
`eco skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.eco/config.yaml under:
...
from eco_cli.config import cfg_get, load_config, save_config
from eco_cli.colors import Colors, color
from eco_cli.platforms import PLATFORMS as _PLATFORMS
