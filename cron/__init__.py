"""
Cron job scheduling system for ECO Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    eco gateway install    # Install as a user service
    sudo eco gateway install --system  # Linux servers: boot-time system service
    eco gateway            # Or run in foreground
