...
const STORAGE_KEY = "eco-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `eco_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "eco-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-eco-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-eco-theme-font", "true");
