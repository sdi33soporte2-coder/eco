#!/usr/bin/env python3
"""
SWE Runner with ECO Trajectory Format

A runner that uses ECO-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the ECO-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses ECO-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in ECO format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches ECO-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using ECO-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with ECO Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses ECO-Agent's built-in execution environments
    and outputs trajectories in ECO-Agent format.
    """
    ...
    def _convert_to_eco_format(
        ...
        """
        Convert internal message format to ECO trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to ECO trajectory format
        trajectory = self._convert_to_eco_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with ECO trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with ECO Trajectory Format")
    print("=" * 60)
