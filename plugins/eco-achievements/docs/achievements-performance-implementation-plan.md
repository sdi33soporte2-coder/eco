# ECO Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.eco/plugins/eco-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.eco/plugins/eco-achievements/scan_checkpoint.json`.
