# ECO Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.eco/plugins/eco-achievements/state.json` (existing unlock state)
  - `~/.eco/plugins/eco-achievements/scan_snapshot.json` (new)
  - `~/.eco/plugins/eco-achievements/scan_checkpoint.json` (new)
