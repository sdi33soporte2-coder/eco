...
``_check_spotify_available()`` — when the user has not run ``eco auth
spotify``, the tools remain registered (so they appear in ``eco
...
The Spotify auth flow (``eco auth spotify``), CLI plumbing, and docs
