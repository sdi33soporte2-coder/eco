...
required — uses aiohttp which is already a ECO dependency.
...
def interactive_setup() -> None:
    ...
    ``eco_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where ECO delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # eco_cli/setup.py::_setup_mattermost function.
