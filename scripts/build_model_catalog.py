#!/usr/bin/env python3
"""Build the ECO Model Catalog — a centralized JSON manifest of curated models.
...
ECO CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a ECO release.
...
``https://eco.nousresearch.com/docs/api/model-catalog.json``
"""
...
# Ensure ECO_HOME is set for imports that touch it at module level.
os.environ.setdefault("ECO_HOME", os.path.join(os.path.expanduser("~"), ".eco"))

from eco_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "eco repo",
            "docs": "https://eco.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
