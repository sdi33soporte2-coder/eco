...
DEFAULT_DATASETS = [
    ...
    "NousResearch/hermes-agent-agent-megascience-sft1",
    "NousResearch/ECO-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/ECO-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-eco"
]
