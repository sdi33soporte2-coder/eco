#!/usr/bin/env python3
"""Build the ECO Skills Index — a centralized JSON catalog of all skills.
...
`eco skills search/install` can use it without hitting the GitHub API.
...
# Ensure ECO_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building ECO Skills Index...", flush=True)
