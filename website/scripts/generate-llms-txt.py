#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the ECO docs site.
...
Both publish at:
  https://eco.nousresearch.com/docs/llms.txt
  https://eco.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://eco.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use ECO as a Python Library", None),
        ("guides/use-mcp-with-eco", "Use MCP with ECO", None),
        ("guides/use-voice-mode-with-eco", "Use Voice Mode with ECO", None),
        ("guides/use-soul-with-eco", "Use SOUL.md with ECO", None),
        ("guides/build-a-eco-plugin", "Build a ECO Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with ECO"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "eco/main/scripts/install.sh | bash`  "
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# ECO Agent — Full Documentation\n",
        (
            "This file is the entire ECO Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using ECO, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://eco.nousresearch.com/docs\n",
        "Short index: https://eco.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
