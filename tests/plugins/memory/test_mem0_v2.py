...
class TestMem0FiltersV2:
    ...
    def test_write_filters_include_agent_id(self):
        ...
        provider._user_id = "u123"
        provider._agent_id = "eco"
        assert provider._write_filters() == {"user_id": "u123", "agent_id": "eco"}
...
class TestMem0Defaults:
    ...
    def test_default_user_id_eco_user(self, monkeypatch, tmp_path):
        ...
        assert provider._user_id == "eco-user"
