...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from eco_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ECO_OVERLAYS
        overlay = ECO_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify eco doctor recognizes Xiaomi env vars."""
