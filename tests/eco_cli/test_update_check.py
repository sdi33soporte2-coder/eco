"""Tests for the update check mechanism in eco_cli.banner."""
...
def test_check_for_updates_no_git_dir(tmp_path, monkeypatch):
    ...
    fake_banner = tmp_path / "eco_cli" / "banner.py"
...
def test_invalidate_update_cache_clears_all_profiles(tmp_path):
    ...
    from eco_cli.main import _invalidate_update_cache

    # Build a fake ~/.eco with default + two named profiles
