...
The main() function in eco_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `eco -c model`
...
def _build_parser():
    """Build a minimal replica of the eco top-level parser."""
