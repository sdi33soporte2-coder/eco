...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("eco_cli.config.get_config_path", return_value=config_path), \
             patch("eco_cli.config.ensure_eco_home"):
    ...
    def test_ensure_eco_home_sets_0700(self):
        home = Path(self.tmpdir) / ".eco"
        with patch("eco_cli.config.get_eco_home", return_value=home):
