...
The unit tests in tests/eco_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned eco-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/eco")
from eco_cli.service_manager import S6ServiceManager
