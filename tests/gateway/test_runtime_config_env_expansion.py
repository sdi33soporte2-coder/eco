...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("ECO_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("ECO_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    monkeypatch.delenv("ECO_GATEWAY_BUSY_INPUT_MODE", raising=False)
    monkeypatch.delenv("ECO_RESTART_DRAIN_TIMEOUT", raising=False)
    monkeypatch.delenv("ECO_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
