...
import type { ScrollBoxHandle } from '@eco/ink'
import { evictInkCaches } from '@eco/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ECO_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
