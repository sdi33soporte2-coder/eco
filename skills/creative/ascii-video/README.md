...
Built for [ECO Agent](https://github.com/NousResearch/hermes-agent-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/hermes-agent-agent/skills/creative/ascii-video`](https://github.com/NousResearch/hermes-agent-agent/tree/main/skills/creative/ascii-video) via PR.
