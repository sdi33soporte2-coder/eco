...
```python
import sys
sys.path.insert(0, "/home/teknium/.eco/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.eco/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — ECO installs package this)
