...
Usage in execute_code:
    exec(open(os.path.join(os.environ.get("ECO_HOME", os.path.expanduser("~/.eco")), "skills/red-teaming/godmode/scripts/godmode_race.py")).read())
