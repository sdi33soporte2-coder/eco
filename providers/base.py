...
def _profile_user_agent() -> str:
    """Return a ``eco-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from eco_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"eco-cli/{_ver}"
    except Exception:
        return "eco-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # eco-cli UA so the catalog endpoint is reachable.
