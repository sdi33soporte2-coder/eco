...
Trust levels:
  - builtin:   Ships with ECO. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.eco/\.env|\~/\.eco/\.env',
     "eco_env_access", "critical", "exfiltration",
     "directly references ECO secrets file"),
    ...
    (r'\.eco/config\.yaml|\.eco/SOUL\.md',
     "eco_config_mod", "critical", "persistence",
     "references ECO configuration files directly"),
