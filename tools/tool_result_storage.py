...
2. **Per-result persistence** (maybe_persist_tool_result): After a tool
   ...
   SANDBOX temp dir (for example /tmp/eco-results/{tool_use_id}.txt on
   standard Linux, or $TMPDIR/eco-results/{tool_use_id}.txt on Termux)
...
STORAGE_DIR = "/tmp/eco-results"
HEREDOC_MARKER = "ECO_PERSIST_EOF"
...
def _heredoc_marker(content: str) -> str:
    ...
    return f"ECO_PERSIST_{uuid.uuid4().hex[:8]}"
