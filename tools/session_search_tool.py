...
the get_anchored_view / get_messages_around primitives in eco_state.
...
# Third-party integrations tag their sessions with ECO_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from eco_state import DEFAULT_DB_PATH
