...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - eco_home (str): The active ECO_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.eco``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "eco").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'eco memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], eco_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'eco memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``eco_home`` is the active ECO_HOME directory path.
