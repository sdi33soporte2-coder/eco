...
Config: ~/.eco/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.eco/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_eco_home()`` helper (ECO_HOME-aware and
...
RULES_FILE = get_eco_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_eco_home() / "feishu_comment_pairing.json"
