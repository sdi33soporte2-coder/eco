...
version: 0.1.0
author: Hugo Sequier (Hugo-SEQUIER), ECO Agent
license: MIT
...
The script reads `~/.eco/.env` for two optional defaults:
...
Helper script: `~/.eco/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.eco/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.eco/.env`.
...
```bash
python3 ~/.eco/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.eco/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
