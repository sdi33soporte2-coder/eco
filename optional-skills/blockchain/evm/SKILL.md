...
version: 1.0.0
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), ECO Agent
license: MIT
...
Helper script path: `~/.eco/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.eco/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.eco/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.eco/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
