...
Data file: $ECO_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ECO_HOME = Path(os.environ.get("ECO_HOME", Path.home() / ".eco"))
DATA_DIR = _ECO_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
